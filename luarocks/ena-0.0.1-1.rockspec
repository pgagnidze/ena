...
build = {
  ...
  modules = {
    ["ena"] = "ena.lua",
    ["parser"] = "ena/parser.lua",
    ["compiler"] = "ena/compiler.lua",
    ["interpreter"] = "ena/interpreter.lua",
    ["transpiler"] = "ena/transpiler.lua",
    ["lang.literals"] = "ena/lang/literals.lua",
    ["lang.translator"] = "ena/lang/translator.lua",
    ["helper.common"] = "ena/helper/common.lua",
    ["helper.pegdebug"] = "ena/helper/pegdebug.lua",
    ["helper.pt"] = "ena/helper/pt.lua",
    ["spec.e2e"] = "ena/spec/e2e.lua",
  },
  install = {
    bin = {
      ena = 'ena.lua'
